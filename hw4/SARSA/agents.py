...
class GridWorldAgent:
    ...
    def learn(self, reward, current_state, current_action, next_state, next_action, step_size=0.1):

        self._update_q_estimate(reward, current_state, current_action, next_state, next_action, step_size=step_size)
    ...
    def _update_q_estimate(self, reward, current_state, current_action, next_state, next_action, step_size):
        # update rule
        cur_q = self.Q[current_state, current_action]
        self.Q[current_state, current_action] = cur_q + step_size * (reward + GAMMA * self.Q[next_state][next_action] - cur_q)
